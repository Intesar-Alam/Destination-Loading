...
import learn.destinationLoading.domain.AppUserService;
...
public class AppUserController {
    ...
    public ResponseEntity<?> create(@RequestBody Map<String, String> body) {
        try {
            AppUser appUser = service.create(body.get("username"), body.get("password"), Integer.parseInt(body.get("companyId")));
