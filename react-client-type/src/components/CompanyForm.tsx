        ...
        <Card className="rounded-0 col-md-8 mx-auto">
          <Form onSubmit={handleSubmit}>
            <Form.Group as={Row} className="my-2 ms-3" controlId="formCompanyName">
              ...
              <Col sm={9}>
                <Form.Control type="text" placeholder="Enter Company Name" value={company['companyName']} onChange={handleChange} />
              </Col>
            </Form.Group>
            <Form.Group as={Row} className="mb-2 ms-3" controlId="formCompanyUrl">
              <Form.Label column sm={2}>Company URL/Website</Form.Label>
              <Col sm={9}>
                <Form.Control type="text" placeholder="Enter Company URL" value={company['url']} onChange={handleChange} />
              </Col>
            </Form.Group>
            <Form.Group as={Row} className="mb-2 ms-3" controlId="formIcon">
              <Form.Label column sm={2}>Company Icon</Form.Label>
              <Col sm={9}>
                <Form.Control type="text" placeholder="icon" value={company['icon']} onChange={handleChange} />
              </Col>
            </Form.Group>
            {/* <Form.Group as={Row} className="mb-2 ms-3" controlId="formTransportationMode">
              <Form.Label column sm={2}>Transport Mode</Form.Label>
              <Col sm={9}>
                <Form.Select aria-label="Select Transportation Mode" value={company['transportationMode']} onChange={handleChange}>
